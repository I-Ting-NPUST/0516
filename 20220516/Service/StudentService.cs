...
namespace _0516.Service
{
    public class StudentService : IStudentService
    {
        ...
        (int total, List<Student>) IStudentService.GetStudents(int offset, int count)
        {
            throw new System.NotImplementedException();
        }

        (int total, List<Student>) IStudentService.GetStudents(int offset, int count, Dictionary<string, string> queryDic)
        {
            throw new System.NotImplementedException();
        }

        Student IStudentService.GetStudentByStudentNo(string studentNo)
        {
            throw new System.NotImplementedException();
        }
        ...
        bool IStudentService.DeleteStudent(string studentNo)
        {
            throw new System.NotImplementedException();
        }

        bool IStudentService.CreateStudent(Student student)
        {
            throw new System.NotImplementedException();
        }
    }
